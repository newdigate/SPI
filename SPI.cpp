...
void SPIClass::begin()
{
	...
	CCM_CBCMR = (CCM_CBCMR & ~(CCM_CBCMR_LPSPI_PODF_MASK | CCM_CBCMR_LPSPI_CLK_SEL_MASK)) |
		CCM_CBCMR_LPSPI_PODF(2) | CCM_CBCMR_LPSPI_CLK_SEL(1); // pg 1049
//		CCM_CBCMR_LPSPI_PODF(6) | CCM_CBCMR_LPSPI_CLK_SEL(2); // pg 1049
...
#endif
SPIClass SPI1(IMXRT_LPSPI3_ADDRESS, SPIClass::spiclass_lpspi3_hardware);
...
/**********************************************************/
/*     32 bit MIMXRT1176 (RT1170-EVKB)                    */
/**********************************************************/

#elif defined(__IMXRT1176__)

// Register-op source of truth: the HW-verified RT1176 core driver
// (cores/imxrt1176/SPI.cpp). The method shapes come from the Teensy-4 branch
// above, but every register/clock/pin operation below is the core's LPSPI1
// logic, re-expressed through this library's method signatures:
